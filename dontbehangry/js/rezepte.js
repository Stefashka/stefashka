...
const REZEPTE = [

  {
    ...
    untertitel: "Blätterteig, Puddingcreme, 240 Grad. Die schwarzen Flecken sind Absicht.",
    kategorie: "Süß",
    bild: {
      datei: "bilder/pastel-de-nata.jpg",
      alt: "Vier Pastéis de Nata mit dunkel gefleckter Creme auf einem runden Holzbrett",
      fokus: "center",
      quelle: "eigenes Foto"
    },
    herkunft: {
...

  {
    id: "joghurtkruste",
    titel: "Joghurtkruste",
    untertitel: "Topfbrot mit Joghurt, geht im kalten Ofen auf. Anders als die meisten Pläne.",
    kategorie: "Brot",
    bild: null,
    herkunft: {
      typ: "Website",
...

  {
    ...
    untertitel: "Selbst gefüllte Röhren – die Fleißarbeit von gestern rettet den heutigen Abend.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "Website",
...

  {
    ...
    untertitel: "Fünf Minuten, ein Mixer, süß-scharf. Verschwindet schneller, als er entsteht.",
    kategorie: "Aufstrich",
    bild: null,
    herkunft: {
      typ: "Instagram",
      text: "@geschmacksliebe",
      archiv: "quellen/curry-dattel-dip-geschmacksliebe.jpg",
      erfasst: "2026-07-31"
    },
    portionen: 8,
    portionenName: "Portionen",
...

  {
    id: "soljanka",
    titel: "Soljanka",
    untertitel: "Wurst, Gewürzgurken, Säure – sieht nach Resteessen aus, schmeckt nach mehr.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
      text: "ausgedrucktes Rezeptblatt, Titel dort „Ukrainische Soljanka“, Verfasser unbekannt",
      archiv: "quellen/russische_soljanka.jpg",
      erfasst: "2026-07-31"
    },
    portionen: 8,
    portionenName: "Portionen",
...

  {
    ...
    untertitel: "Sieben Zutaten, mit Absicht zu dunkel gebacken. Innen bleibt er fast roh.",
    kategorie: "Süß",
    bild: null,
    herkunft: {
      typ: "Website",
...

  {
    ...
    untertitel: "Quark-Öl-Teig ohne Gehzeit, ein ganzes Blech. Hält zwei Tage, meistens zwei Stunden.",
    kategorie: "Süß",
    bild: null,
    herkunft: {
      typ: "Website",
...

  {
    ...
    untertitel: "Oliven, Gurke, Tomate, Feta – fünfzehn Minuten für den Ruf, gut kochen zu können.",
    kategorie: "Deftig",
    bild: {
...

  {
    id: "jaegersauce",
    titel: "Jägersauce",
    untertitel: "Champignons, Butter, Sahne, kein Messbecher. Wird gut, wenn man sie in Ruhe lässt.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
      text: "Vorwerk · Rezeptkarte „Jägersauce – Jägersoße TM31“",
      archiv: "quellen/jaegersauce-vorwerk-tm31.jpg",
      erfasst: "2026-08-01"
    },
    portionen: 4,
    portionenName: "Portionen",
...

  {
    ...
    untertitel: "Keine Gehzeit, kalter Ofen, vierzig Minuten. Schneller als der Weg zum Bäcker.",
    kategorie: "Brot",
    bild: null,
    herkunft: {
      typ: "Website",
...

  {
    ...
    untertitel: "Kokosmilch, Garam Masala, Hühnchen. Cremig genug, um Streit zu beenden.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
      text: "Vorwerk · Rezeptkarte „Indisches Butter Chicken TM31“",
      archiv: "quellen/indisches_butter_chicken.jpg",
      erfasst: "2026-08-01"
    },
    portionen: 4,
    portionenName: "Portionen",
...

  {
    ...
    untertitel: "Ofenkartoffeln und Senfsauce laufen parallel. Einmal im Leben klappt Multitasking.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
      text: "Marley Spoon · Rezeptkarte",
      archiv: "quellen/Huenchen_senf_II.jpg",
      erfasst: "2026-08-01"
    },
    portionen: 2,
    portionenName: "Portionen",
...

  {
    ...
    untertitel: "Hackbraten mit Schafskäse im Bauch. Sieht aufgeschnitten besser aus, als es klingt.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "Zeitschrift",
...

  {
    ...
    untertitel: "Schokoladenboden, rosa Sahne, dünne Erdbeeren. Sieht harmlos aus, ist es nicht.",
    kategorie: "Süß",
    bild: null,
    herkunft: {
      typ: "Zeitschrift",
...

  {
    ...
    untertitel: "Räucherlachs, Kräuterquark, Apfel-Möhren-Salat. Sättigt vier Leute oder eine schlechte Woche.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
...

  {
    ...
    untertitel: "Kapernsauce, Salzkartoffeln, Schnittlauch. Älter als die meisten Landkarten.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
...

  {
    ...
    untertitel: "Geraspelte Karotten, frisches Basilikum, halbe Stunde. Das Gemüse fällt niemandem auf.",
    kategorie: "Deftig",
    bild: null,
    herkunft: {
      typ: "PDF",
