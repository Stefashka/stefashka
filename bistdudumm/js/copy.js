...
export const PREP_TITLE = 'Halte das Handy vor deine Brust oder Stirn';
export const PREP_SUBS = [
  ...
  'Stirn wirkt alberner. Nimm die Stirn.',
];
...
export const AI_NOT_CONNECTED =
  'In js/config.js fehlen die Supabase-Zugangsdaten – ohne die kann der ' +
  'Generator nichts erzeugen.';
