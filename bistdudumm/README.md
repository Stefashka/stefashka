...
> 2. **Schnell für zwischendurch:** einen Mini-Server im Projektordner starten:
>    ```bash
>    cd bist-du-dumm
>    python3 -m http.server 8080
>    ```
>    und `http://localhost:8080` im Browser öffnen. Design und Spielablauf
...
Nach ca. 30 Sekunden gibt es eine URL wie `bist-du-dumm.vercel.app` – mit HTTPS.
...
Spieloberfläche mit – die Erklärenden lesen immer aufrecht, und der Begriff wird
deutlich größer.
...
├── vercel.json              Header, Caching, Permissions-Policy
├── css/
